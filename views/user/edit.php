	...
	<form action="<?php echo URL; ?>user/editSave/<?php echo $this->user['id'] ;?>" method="post">
		<div class="row">
			<div class="input-field col s12">
				<input id="username" type="email" name="username" value="<?php echo $this->user['users'] ;?>" class="validate">
			<label for="username"><?php echo $this->label_username;?></label>
        	</div>
      	  </div>
    	  <div class="row">
        	<div class="input-field col s12">
          		<input id="password" type="password" name="password" value="<?php echo $this->user['password'] ;?>" class="validate">
