...
if(isset($_POST['btn-submit']))
{
	...
	if($stmt->rowCount() == 1)
	{
		...
		$message= "
				   ...
				   <br /><br />
				   <a href='http://localhost/webserver/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
				   <br /><br />
				   thank you :)
				   ";
...
<html>
  <head>
    ...
    <link href="../vendor/jscustom/styles.css" rel="stylesheet" media="screen">
