...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../vendor/jscustom/bootstrap.css">
	<script type="text/javascript" src="../vendor/jscustom/jquery.js"></script>
	<script type="text/javascript" src="../vendor/jscustom/bootstrap.js"></script>
		<script type="text/javascript" src="../vendor/jscustom/scripts.js"></script>
	
	--><!-- Bootstrap CSS and bootstrap datepicker CSS used for styling the pages-->
...
<!--	<link rel="stylesheet" type="text/css" href="../vendor/jquery-ui-1.11.2/jquery-ui.css">-->
	...
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="http://localhost" class="navbar-brand">HOME PAGES</a>
	...
	<div class="col-md-2">
		<div class="row">
			<?php 
   					...
   					$stmt = $user_home->runQuery("SELECT foto FROM admin WHERE uname =:use");
					$stmt->execute(array(":use"=>$use));
  					if($stmt->rowCount()>0)
  					{
   					while($row = $stmt->fetch(PDO::FETCH_ASSOC))
   					{
				...
				<div class="col-xs-6 col-md-12">
					<a class="thumbnail">
						<img class="img-responsive" src="foto/<?php echo $row['foto']; ?>">
					</a>
				</div>
				<?php 
				} 
