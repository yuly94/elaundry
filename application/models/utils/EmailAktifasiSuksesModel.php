...
class EmailAktifasiSuksesModel {
 

    public static function kirim($konsumen_email, $konsumen_nama) {
     //send email
            $to = $konsumen_email; 
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tbody><tr>
                            ...
                            <br>
                            <br>
                             Selamat $konsumen_nama , Account anda telah berhasil diaktifasi, silahkan login untuk menikmati layanan kami
                            <br>
                            <br>
                            </td>
                          </tr>
