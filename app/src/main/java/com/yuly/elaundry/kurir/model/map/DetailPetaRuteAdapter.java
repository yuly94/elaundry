...
public class DetailPetaRuteAdapter extends RecyclerView.Adapter<DetailPetaRuteAdapter.ViewHolder> {
    ...
    public DetailPetaRuteAdapter(List myMaps, MapFABonClickListener mapFABonClick) {
        this.myMaps = myMaps;
        this.mapFABonClick = mapFABonClick;
    }

    // Create new views (invoked by the layout manager)
    @Override public DetailPetaRuteAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
