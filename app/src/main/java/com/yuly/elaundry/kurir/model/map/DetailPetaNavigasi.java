...
public class DetailPetaNavigasi {
    /**
    ...
    private static DetailPetaNavigasi navigator = null;


    private DetailPetaNavigasi() {
     ...
     */
    public static DetailPetaNavigasi getNavigator() {
        if (navigator == null) {
            navigator = new DetailPetaNavigasi();
        }
        return navigator;
    }
