...
public class RoutingDbHandler extends SQLiteOpenHelper {

	private static final String TAG = RoutingDbHandler.class.getSimpleName();
	...
	// Database Name
	private static final String DATABASE_NAME = "android_routing_kurir.db";
	...
	public RoutingDbHandler(Context context) {
