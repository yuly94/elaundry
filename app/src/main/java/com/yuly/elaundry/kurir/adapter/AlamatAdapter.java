package com.yuly.elaundry.kurir.adapter;
...
import com.yuly.elaundry.kurir.models.AlamatModels;
import com.yuly.elaundry.kurir.widgets.BubbleTextGetter;
 ...
 */
public class AlamatAdapter extends RecyclerView.Adapter<AlamatAdapter.GmailVH>  implements BubbleTextGetter {
   ...
   // List<PesananModels> superHeroes;
    ...
    private List<AlamatModels> dataList;
    private boolean isDarkTheme;

    public AlamatAdapter(List<AlamatModels> alamatList, Context context){
        this.dataList = new ArrayList<AlamatModels>();
        this.mContext = context;
        this.dataList = alamatList;
    }
...
/*        if (!isDarkTheme){
    ...
    public void onBindViewHolder(GmailVH gmailVH, int i) {
        ...
        final AlamatModels alamatModels = dataList.get(i);


        gmailVH.title_doa.setText(alamatModels.getAlamatNama());
        gmailVH.title_hr.setText(alamatModels.getAlamatJalan());

        letter = String.valueOf(alamatModels.getAlamatNama().charAt(0));
    ...
    public void setFilter(List<AlamatModels> AlamatModels){
        dataList = new ArrayList<AlamatModels>();
        dataList.addAll(AlamatModels);
        notifyDataSetChanged();
    }


    // Add a list of items
    public void addAll(List<AlamatModels> AlamatModels){
