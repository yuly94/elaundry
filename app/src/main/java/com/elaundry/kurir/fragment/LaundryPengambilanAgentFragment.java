...
import com.elaundry.kurir.activity.DetailPemesananActivity;
import com.elaundry.kurir.adapter.PemesananAdapter;
...
import com.elaundry.kurir.listeners.RecyclerTouchListener;
import com.elaundry.kurir.widgets.FastScroller;
...
public class LaundryPengambilanAgentFragment extends Fragment implements SearchView.OnQueryTextListener{
 ...
 //   private StatesRecyclerViewAdapter statesRecyclerViewAdapter;
   ...
   // private SimpleStringAdapter adapter;
    ...
    private String pemesanan_status = "diserahkan ke agent";
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), mRecyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
              ...
              //  Toast.makeText(getActivity(), transaksi.getNoId() + " is selected!", Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra("TEXT_TOMBOL", "mengambil dari agent");
                intent.putExtra("STATUS_SEBELUMNYA", "diserahkan ke agent");
                intent.putExtra("UPDATE_STATUS", "mengambil dari agent");
...
*/
     ...
     */
    private void mengambilDataLaundry() {
        showProgressDialog();
